...
var e = Object.create,
          ...
          ee(o)
            ...
            : o != null &&
              (ne(o) &&
                (o = T(
                  o,
                  i + (o.key == null || (e && e.key === o.key) ? "" : ("" + o.key).replace(ie, "$&/") + "/") + c
                )),
              r.push(o)),
          1
        );
      ...
      (e.unstable_scheduleCallback = function (r, i, a) {
        ...
        return (
          ...
          a > o
            ...
            : ((r.sortIndex = s), t(c, r), m || p || ((m = !0), ee || ((ee = !0), ne()))),
          r
        );
      }),
  ...
  h = /* @__PURE__ */ o(e => {
    ...
    function xi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == "function")) vi(e) && (s = 1);
        ...
        a: switch (e) {
          ...
          case w:
            return ((e = _i(19, n, t, a)), (e.elementType = w), (e.lanes = o), e);
          default:
    ...
    function Wa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null && (t.elementType === i || (typeof i == "object" && i && i.$$typeof === ne && Fa(i) === t.type))
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === y)) {
                      ...
                      r.elementType === l ||
                      (typeof l == "object" && l && l.$$typeof === ne && Fa(l) === r.type)
                    ) {
    ...
    var ao = pe(null),
      oo = pe(0);
    function so(e, t) {
      ((e = Gl), k(oo, e), k(ao, t), (Gl = e | t.baseLanes));
    }
    function co() {
      (k(oo, Gl), k(ao, ao.current));
    }
    function lo() {
      ((Gl = oo.current), O(ao), O(oo));
    }
    var uo = pe(null),
      fo = null;
    function po(e) {
    ...
    function mo(e) {
      (k(N, N.current), k(uo, e), fo === null && (fo = e));
    }
    function ho(e) {
      e.tag === 22 ? (k(N, N.current), k(uo, e), fo === null && (fo = e)) : go(e);
    }
    function go() {
      (k(N, N.current), k(uo, uo.current));
    }
    function _o(e) {
      (O(uo), fo === e && (fo = null), O(N));
    }
    var N = pe(0);
    function vo(e) {
      for (var t = e; t !== null; ) {
      ...
      switch ((Bi(t), t.tag)) {
        ...
        case 27:
          if ((xe(t), (n = ge.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = me.current), Yi(t) ? qi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Lc(t)));
          }
          return (B(t), null);
        case 5:
        ...
        case 19:
          if ((O(N), (r = t.memoizedState), r === null)) return (B(t), null);
                ...
                for (e = t.child; e !== null; ) {
                  if (((o = vo(e)), o !== null)) {
                    for (
                      ...
                      (bi(n, e), (n = n.sibling));
                    return (k(N, (N.current & 1) | 2), j && Li(t, r.treeForkCount), t.child);
                  }
                  e = e.sibling;
                }
              r.tail !== null && Pe() > nu && ((t.flags |= 128), (a = !0), Vc(r, !1), (t.lanes = 4194304));
            }
          else {
            if (!a)
              if (((e = vo(o)), e !== null)) {
    ...
    var zl = {
      ...
      fu = null;
    function pu() {
      return W & 2 && q !== 0 ? q & -q : E.T === null ? ft() : dd();
    }
    function mu() {
      if (Yl === 0)
        if (!(q & 536870912) || j) {
    ...
    function Au(e, t) {
      ...
      while (1);
      return ((ta = ea = null), (E.H = r), (E.A = a), (W = n), K === null ? ((G = null), (q = 0), li(), Y) : 0);
    }
    function ju() {
      for (; K !== null && !Me(); ) Mu(K);
    }
    ...
    function Wu(e, t, n) {
      ((t = Di(n, t)), (t = rc(e.stateNode, t, 2)), (e = Za(e, t, 2)), e !== null && (at(e, 2), rd(e)));
    }
    function Z(e, t, n) {
      if (e.tag === 3) Wu(e, e, n);
      else
        for (; t !== null; ) {
          if (t.tag === 3) {
            ...
            if (
              ...
              ((e = Di(n, e)), (n = ic(2)), (r = Za(t, n, 2)), r !== null && (ac(n, r, t, e), at(r, 2), rd(r)));
              break;
            }
          }
          t = t.return;
    ...
    function Ku(e, t, n) {
      ...
      (r !== null && r.delete(t),
        ...
        G === e &&
          (q & n) === n &&
          (Y === 4 || (Y === 3 && (q & 62914560) === q && 300 > Pe() - eu) ? !(W & 2) && Su(e, 0) : (Jl |= n),
          Xl === q && (Xl = 0)),
        rd(e));
    }
    function qu(e, t) {
          ...
          a: {
            ...
            if (
              ...
              if (
                ...
                (c.relatedTarget = h),
                (g = null),
                wt(i) === r && ((d = new d(p, m + "enter", u, n, i)), (d.target = h), (d.relatedTarget = f), (g = d)),
                (f = g),
                l && u)
              )
                b: {
...
function w({ from: e, to: t, order: n = 1, label: r }) {
  let [i, a] = e,
    [o, s] = t;
  if (n === 1)
...
function ie() {
  return /* @__PURE__ */ (0, x.jsxs)("g", {
    "aria-label": "Wheland intermediate ring with explicit bond orders",
    children: [
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c1,
        to: T.c2,
        order: 1,
        label: "C1-C2 single bond",
      }),
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c2,
        to: T.c3,
        order: 1,
        label: "C2-C3 single bond",
      }),
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c3,
        to: T.c4,
        order: 2,
        label: "C3-C4 double bond",
      }),
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c4,
        to: T.c5,
        order: 1,
        label: "C4-C5 single bond",
      }),
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c5,
        to: T.c6,
        order: 2,
        label: "C5-C6 double bond",
      }),
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c6,
        to: T.c1,
        order: 1,
        label: "C6-C1 single bond",
      }),
      /* @__PURE__ */ (0, x.jsx)(te, {
        x: 266,
        y: 122,
      ...
      /* @__PURE__ */ (0, x.jsx)("text", {
        ...
        y: "252",
        textAnchor: "middle",
        children: "one resonance form of the arenium ion is shown",
      }),
    ],
  });
}
function ae({ x: e = 300, y: t = 66 }) {
  return /* @__PURE__ */ (0, x.jsxs)("g", {
...
function oe({ x: e = 245, y: t = 42 }) {
  return /* @__PURE__ */ (0, x.jsxs)("g", {
    "aria-label": "nitro group bonded through nitrogen",
    children: [
      /* @__PURE__ */ (0, x.jsx)("text", {
        className: "mechanism-svg__atom",
        x: e,
...
function ce() {
  return /* @__PURE__ */ (0, x.jsx)("text", {
    ...
    y: "268",
    textAnchor: "middle",
    children: "conc. HNO₃ / conc. H₂SO₄, 50–55 °C",
  });
}
//#endregion
  ...
  return /* @__PURE__ */ (0, x.jsxs)("g", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, x.jsx)("text", {
        ...
        y: "270",
        textAnchor: "middle",
        children: "attacked carbon is locally sp³; aromaticity is temporarily lost",
      }),
    ],
  });
}
  ...
  return /* @__PURE__ */ (0, x.jsxs)("g", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, x.jsx)(w, {
        ...
        to: e,
        order: 1,
        label: "C-H bond whose electrons restore the pi system",
      }),
      /* @__PURE__ */ (0, x.jsx)(w, {
        from: T.c1,
        to: t,
        order: 1,
        label: "C-N bond to nitro group",
      }),
      /* @__PURE__ */ (0, x.jsx)("text", {
        className: "mechanism-svg__atom",
        x: e[0] - 10,
      ...
      /* @__PURE__ */ (0, x.jsx)("text", {
        ...
        x: "204",
        y: "86",
        children: "C–H bond electrons return to ring",
      }),
    ],
  });
}
  ...
  return /* @__PURE__ */ (0, x.jsxs)("g", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, x.jsx)("text", {
        ...
        y: "250",
        textAnchor: "middle",
        children: "nitrobenzene + regenerated H₂SO₄",
      }),
    ],
  });
}
function k({ step: e }) {
  return /* @__PURE__ */ (0, x.jsxs)("svg", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, x.jsxs)("g", {
        children: [
          e === "electrophile-generation" && /* @__PURE__ */ (0, x.jsx)(ue, {}),
          e === "electrophilic-attack" && /* @__PURE__ */ (0, x.jsx)(de, {}),
          e === "wheland-intermediate" && /* @__PURE__ */ (0, x.jsx)(fe, {}),
          e === "deprotonation" && /* @__PURE__ */ (0, x.jsx)(pe, {}),
          e === "product" && /* @__PURE__ */ (0, x.jsx)(O, {}),
          /* @__PURE__ */ (0, x.jsx)(ce, {}),
        ],
      }),
    ],
...
function me({ step: e }) {
  let t = (0, b.useMemo)(() => D.filter(t => t.step === e), [e]);
  ...
  return /* @__PURE__ */ (0, x.jsxs)("section", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, x.jsx)("div", {
        ...
        "aria-live": "polite",
        children: /* @__PURE__ */ (0, x.jsx)(k, { step: n.id }),
      }),
      /* @__PURE__ */ (0, x.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, x.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, x.jsx)("button", {
                type: "button",
                onClick: () => t(e => Math.min(le.length - 1, e + 1)),
                disabled: e === le.length - 1,
...
function ge() {
  let e = (0, b.useMemo)(() => D.filter(e => e.severity === "required").length, []);
            ...
            children: [
              /* @__PURE__ */ (0, x.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, x.jsx)("h1", { children: "Nitration of benzene" }),
                  /* @__PURE__ */ (0, x.jsx)("p", {
                  ...
                  /* @__PURE__ */ (0, x.jsxs)("article", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, x.jsxs)("strong", {
                        children: [le.length, " steps · ", e, " required constraints"],
                      }),
                    ],
                  }),
                ],
...
((0, y.createRoot)(_e).render(
  /* @__PURE__ */ (0, x.jsx)(b.StrictMode, { children: /* @__PURE__ */ (0, x.jsx)(ge, {}) })
),
