...
var e = Object.create,
  ...
  h = /* @__PURE__ */ o(e => {
    ...
    function Ha(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null && (t.elementType === i || (typeof i == "object" && i && i.$$typeof === w && Na(i) === t.type))
    ...
    var Rl = {
      ...
      fu = null;
    function pu() {
      return G & 2 && J !== 0 ? J & -J : T.T === null ? A() : dd();
    }
    function mu() {
      if (Jl === 0)
        if (!(J & 536870912) || N) {
  ...
  switch (n.kind) {
    ...
    case "lonePairRotation": {
      ...
      let n = S(t, r.layout.offset),
        i = se(r.layout.rotation ?? 0);
      return {
        x: Number((n.x + Math.cos(i) * ie).toFixed(2)),
        y: Number((n.y + Math.sin(i) * ie).toFixed(2)),
      };
    }
    case "labelPosition":
    ...
    : de(t, n.annotationId, t => {
        switch (n.kind) {
          case "curlyArrow": {
            ...
            if (n.field === "control1" || n.field === "control2") return fe(t, { [n.field]: r });
            let i = T(e, n.field === "startOffset" ? t.fromAnchorId : t.toAnchorId);
            return i ? fe(t, { [n.field]: oe(i, r) }) : t;
          }
          case "anchoredOffset": {
          ...
          case "lonePairRotation": {
            ...
            return n
              ? {
                  ...
                  layout: {
                    ...t.layout,
                    rotation: ce(S(n, t.layout.offset), r),
                  },
                }
              : t;
          }
          case "labelPosition":
            ...
            if (t.anchorId) {
              let n = T(e, t.anchorId);
              return n ? me(t, { offset: oe(n, r) }) : t;
            }
            return me(t, { position: r });
          case "areniumHorseshoe":
            return t.kind === "areniumHorseshoe" ? pe(t, { start: r }) : t;
          case "areniumHorseshoeSegment":
  ...
  return /* @__PURE__ */ (0, O.jsxs)("g", {
    ...
    children: [
      t
        ...
        .flatMap(n =>
          _e(e, t, n).map(e => {
            let t = r.selectedHandle ? D(r.selectedHandle) === D(e.handle) : !1;
            return /* @__PURE__ */ (0, O.jsxs)(
              "g",
              {
                className: [
  ...
  return /* @__PURE__ */ (0, O.jsxs)("g", {
    ...
    children: [
      /* @__PURE__ */ (0, O.jsx)("polygon", {
        points: w([i.c1, i.c2, i.c3, i.c4, i.c5, i.c6]),
        fill: "none",
      }),
      /* @__PURE__ */ (0, O.jsx)("circle", {
...
function dt({
  ...
  let d = t.filter(e => e.layout.locked).length,
    f = (0, _.useMemo)(
      () => ({
        layoutOverrides: xe(e, t),
        fullAnnotations: Se(e, t),
        selectedAnnotation: n,
      }),
      [t, e, n]
    ),
              ...
              n
                ? /* @__PURE__ */ (0, O.jsxs)(O.Fragment, {
                    children: [
                      ...
                      /* @__PURE__ */ (0, O.jsxs)("p", {
                        className: "mechanism-author__summary",
                        children: ["Handle: ", r ? D(r) : "annotation only"],
                      }),
                    ],
                  })
                : /* @__PURE__ */ (0, O.jsx)("p", {
    ...
    },
    {
      ...
      scaffold: {
        ...
        elements: [
          ...
          pt("nitrobenzene.CN", A(240, 152), A(240, 92), "C-N bond to nitro group in nitrobenzene"),
          ..._t("nitrobenzene.nitro", 240, 76),
        ],
      },
      anchors: {
        ...
        "nitrobenzene.nitroGroup": j("nitrobenzene.nitroGroup", "atom", 240, 76, {
          structureId: "nitrobenzene",
...
function Et(e) {
  ...
  try {
    ...
    return t ? we(E(e.annotations), JSON.parse(t)) : null;
  } catch {
    return null;
  }
}
function Dt(e, t) {
  typeof window > "u" || window.localStorage.setItem(Tt(e.id), JSON.stringify(xe(e, t)));
}
function Ot(e) {
...
function At(e, t) {
  let [n, r] = (0, _.useState)(() => (e ? E(e.annotations) : [])),
  ...
  ((0, _.useEffect)(() => {
    ...
    (r(t ? (Et(e) ?? E(e.annotations)) : e.annotations), a(null), s(!1), (u.current = null));
  }, [t, e]),
    (0, _.useEffect)(() => {
      t && e && Dt(e, n);
    }, [n, t, e]));
  let d = i?.annotationId ?? null,
    ...
    x = (0, _.useCallback)(() => {
      e && (Ot(e.id), r(E(e.annotations)), a(null), (u.current = null), l("Scene draft reset"));
    }, [e]),
    ee = (0, _.useCallback)(() => {
      !e || !d || (r(t => be(e, t, d)), l("Selected annotation reset"));
    }, [e, d]),
    S = (0, _.useCallback)(() => {
    ...
    C = (0, _.useMemo)(
      () =>
        e
          ? {
              layoutOverrides: xe(e, n),
              fullAnnotations: Se(e, n),
              selectedAnnotation: Ce(n, d),
            }
          : {
